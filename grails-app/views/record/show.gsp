...
<html>
    ...
    <body>
        ...
        <div id="show-record" class="content scaffold-show" role="main">
            ...
            <f:display bean="record" />
            <g:form resource="${this.record}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.record}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
